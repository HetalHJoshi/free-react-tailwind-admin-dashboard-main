...
// Import ShowonLogin and ShowonLogout components
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* Dashboard Menu Item with Toggle */}
                    ...
                    <ShowonLogin>
                      <div>
                        ...
                        <NavLink
                          ...
                          onClick={handleClick} // Using handleClick for toggling
                        >
                          Dashboard
                        </NavLink>

                        {/* Submenu for Products and Cart */}
                        {open && (
                          <div className="ml-4">
                            <NavLink
                              to="/ui/products"
