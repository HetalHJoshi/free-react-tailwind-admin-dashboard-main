...
const SignIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(`https://6762631246efb3732374641c.mockapi.io/users?email=${user.email}`);
      ...
      // Store user information in sessionStorage after successful login
